...
#mv AP.nii.gz data.nii.gz
#eddy_correct AP.nii.gz data.nii.gz 0
mv AP.bval bvals
mv AP.bvec bvecs
...
scil_convert_gradient_fsl_to_mrtrix.py bvals bvecs diffusion/encoding.b -f
scil_flip_grad.py --mrtrix diffusion/encoding.b diffusion/encoding_x.b x 
scil_convert_gradient_mrtrix_to_fsl.py diffusion/encoding_x.b diffusion/bvals_x diffusion/bvecs_x -f

#resample t1 image into 1x1x1 
mv T1.nii.gz structural/T1_1x1x1.nii.gz
...
# rename the mask;
bet T1_dti_final.nii.gz t1_brain.nii.gz -m -R -B -f 0.5
