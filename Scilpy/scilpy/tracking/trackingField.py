...
class AbstractField(object):
    ...
    def get_SF(self, pos):
        ...
        """
        scilpy.utils.util.abstract()

    def get_tracking_SF(self, pos, direction):
        """
        return the spherical function thresholded at position pos, for a direction.
        """
        scilpy.utils.util.abstract()
    ...
    def get_tracking_maxima(self, pos, direction):
        """
        return the set of maxima from the thresholded SF at position pos, for a direction.
        """
        scilpy.utils.util.abstract()
    ...
    def get_tracking_SF(self, pos, direction):
        ...
        for i in range(peaks.shape[0]):
            ...
            if norm > self.sf_threshold:
                ...
                elif np.dot(direction, self.get_opposite_direction(d)) > self.cos_theta:
...
class AbstractDiscreteField(AbstractField):
    ...
    def get_opposite_direction(self, ind):
        """
        return the indice of the opposite direction on the sphere to the indice ind.
        """
